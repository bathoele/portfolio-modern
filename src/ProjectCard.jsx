...
export default function ProjectCard({ data }) {
  ...
  return (
    <div className="grid grid-cols-11 gap-5">
      <div className="col-span-3 border-1 border-orange-200 mt-2 h-fit">
        <a href="">
          <img src={new URL(`./assets/${data.image}`, import.meta.url).href}
          alt={data.title} className="w-1/1 relative transition-all duration-300 ease-in-out hover:-translate-y-3 hover:translate-x-2" />
        </a>
      </div>
